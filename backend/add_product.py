...
async def add_product(product_link: str, xpath_to_add_cart_button: str):
    """
...
asyncio.run(add_product(product_link=product_link, xpath_to_add_cart_button=xpath_button_cart))
asyncio.run(add_product(product_link=product_link, xpath_to_add_cart_button=xpath_button_favorite))
